...
eval(base64_decode(""));
//dGVyY2lkdW();
...
Function Ganti($kunci,$ganti,$asal){
    return str_replace($kunci,$ganti,$asal);
}
...
function ban(){
    print n;
    print h." █▀▀▀▀▀  █ ".p." Script : ".name.h." [ ".p."Free Not For Sale".h." ]".n;
    print h." █   ".p."Z".h."   █ ".p." version: ".version.h."     [".k." ©2025 - zerobot".h." ]".n;
    print h." █  ▄▄▄▄▄█ ".p." Channel: ".p."t.me/official_zerobot ".n.n;

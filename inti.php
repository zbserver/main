...
function ban(){
    print n;
    print o." █▀▀▀▀▀  █ ".p." Script : ".name.p." [ ".o.version.p." ]".n;
    print o." █   ".p."Z".o."   █ ".p." Info   : "."Free Not For Sale ".p."[".o." ©2025 - zerobot".p." ]".n;
    print o." █  ▄▄▄▄▄█ ".p." Channel: ".p."t.me/official_zerobot ".n.n;
    print p." Donation ".k." - PAYEER ".p."-> P1087120739".n;
    print k."           - TRX    ".p."-> TCFb3E8KLSua9nWogPkbpZoH9tcJ54Wm7S".n;
    line().n;
}
...
eval(base64_decode(""));